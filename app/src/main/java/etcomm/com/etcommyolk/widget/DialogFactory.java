...
public class DialogFactory {
    ...
    public Dialog showCommonDialog(Context context, String msg, String leftbtnStr, String rightbtnStr, OnClickListener leftBtnClickListener, OnClickListener rightBtnClickListener, int leftTextColor, int rightTextColor) {
    ...
    public Dialog showCommonWithCancelableDialog(Context context, String msg, String leftbtnStr, String rightbtnStr, OnCancelListener onCancelListener, OnClickListener leftBtnClickListener, OnClickListener rightBtnClickListener, int leftTextColor, int rightTextColor) {
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_common_ui, null);
        final Dialog customDialog = new Dialog(context, R.style.commonDialog);
        WindowManager.LayoutParams localLayoutParams = customDialog.getWindow().getAttributes();
        customDialog.onWindowAttributesChanged(localLayoutParams);
...
//    }
    ...
    // 绑定序列号dialog
    public Dialog showbindDialog(Context context, String msg, String leftbtnStr, String rightbtnStr, OnClickListener leftBtnClickListener, OnClickListener rightBtnClickListener, int leftTextColor, int rightTextColor) {
