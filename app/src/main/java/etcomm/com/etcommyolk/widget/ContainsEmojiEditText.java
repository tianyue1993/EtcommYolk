...
public class ContainsEmojiEditText extends EditText {
    protected static final String tag = "ContainsEmojiEditText";
	//输入表情前的光标位置
...
//                    Log.i(tag, "S: "+s.toString()+" start: "+start+"  before: "+before+" count:"+count+" cursorPos:　"+cursorPos);
...
//                           CustomToast.showToast(mContext, "不支持输入Emoji表情符号", Toast.LENGTH_SHORT);
