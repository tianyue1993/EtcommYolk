 ...
 */
public class WeatherHandler extends JsonResponseHandler {
    ...
    public WeatherHandler(String encoding) {
        super(encoding);
    }
                        ...
                        try {
                            if (response.has("code") && !response.isNull("code")) {
                                ...
                                if (code == 0 || code == 30005) {
                                    onSuccess(JSON.parseObject(response.toString(), Weather.class));
                                } else if (code == 10000) {
                                    exceptionCode();
                                } else {
